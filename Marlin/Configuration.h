 ...
 * Authors: Telli Mantelli, Kris Waclawski, Michael Gilardi, Samuel Pinches & Timo
 */
...
#define STRING_CONFIG_H_AUTHOR "(Telli Mantelli, Kris Waclawski, Samuel Pinches, Michael Gilardi, Timo, 1st May 2020)" // Who made the changes.
